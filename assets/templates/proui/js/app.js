...
var App = function() {
    ...
    var uiInit = function() {
        ...
        if (d.getFullYear() === 2020) { yearCopy.html('2020'); } else { yearCopy.html('2020-' + d.getFullYear().toString().substr(0,4)); }

        // Initialize chat demo functionality (in sidebar)
        chatUi();

        // Initialize brand
        $('.sidebar-brand').append('<span class="sidebar-nav-mini-hide"><strong>MFA</strong> app <i class="hi hi-fire"></i></span>');
        $('.full-brand').append('<a href="#" target="_blank"><i>My Feeder assistant</i></a>');
        $('.label-copy').append('Crafted with <i class="fa fa-heart text-danger"></i> by <a href="#" target="_blank"><i>OKTAN TECH</i></a>');
